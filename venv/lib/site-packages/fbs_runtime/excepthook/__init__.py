...
By default, fbs overwrites sys.excepthook for better error reporting:
 ...
 1) Applications based on PyQt or PySide are missing some stack trace entries
...
class _Excepthook:
    ...
    PyQt / PySide applications (see add_missing_qt_frames(...)). Also ensures
...
def add_missing_qt_frames(tb):
    ...
    The problem described here is not specific to PyQt - It occurs for
    PySide as well. To see this, replace PyQt by PySide below.
