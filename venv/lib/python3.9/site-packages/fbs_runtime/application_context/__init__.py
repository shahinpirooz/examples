...
class _ApplicationContext:
    ...
    def app(self):
        ...
        # Import late to avoid circular import __init__ <-> application_context:
        from fbs_runtime import PUBLIC_SETTINGS
        result.setApplicationName(PUBLIC_SETTINGS['app_name'])
        result.setApplicationVersion(PUBLIC_SETTINGS['version'])
        return result
    @cached_property
    def build_settings(self):
        raise RuntimeError(
            "ApplicationContext.build_settings is deprecated. Please use "
            "PUBLIC_SETTINGS from module fbs_runtime instead."
        )
    ...
    def _resource_locator(self):
        if is_frozen():
            ...
            resource_dirs = _source.get_resource_dirs()
